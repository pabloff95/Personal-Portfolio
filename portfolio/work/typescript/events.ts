window.addEventListener("load", function() {
    ...
    const PROJECT3_DESCRIPTION:string = "This project displays the weather of any town introduced by the user. It displays updated weather information provided by the OpenWeather Map API. This allows the user to see the weather of the current day and also the forecast for the next 5 days. " + "<br><br>" +
    ...
    const PROJECT5_DESCRIPTION:string = "This application is a basic calculator developed with React. It performs basic operations and keeps records of all the operations performed in a side panel.";
    const PROJECT6_DESCRIPTION:string = "Data analysis performed to study of impacts of rising temperatures on a plant species population. Analyses and charts performed using R." + "<br><br>" + 
    ...
    let project5:Project = new Project("Calculator", "Application to perform basic operations", "calculator-1.PNG", PROJECT5_DESCRIPTION, null, "https://github.com/pabloff95/React-Calculator");    
    let project6:Project = new Project("Research Study", "Data analysis study on Plant Ecology", "research-study.PNG", PROJECT6_DESCRIPTION, "doi.org/10.6084/m9.figshare.c.5757800", "https://github.com/pabloff95/Research-Study");    
    // Add pictures set    
    ...
    this.document.addEventListener("keyup", function(event){
        ...
        const LEFT_BUTTON: HTMLElement | null = document.getElementById("img-left-button");
        const RIGHT_BUTTON: HTMLElement | null = document.getElementById("img-right-button");
        if (KEY === "ArrowLeft" && LEFT_BUTTON) LEFT_BUTTON.click();
        if (KEY === "ArrowRight" && RIGHT_BUTTON) RIGHT_BUTTON.click();        
    });
